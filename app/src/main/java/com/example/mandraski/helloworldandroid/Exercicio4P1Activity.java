...
public class Exercicio4P1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        spProfissao = (Spinner) findViewById(R.id.spPratica1Exe4Profissao);
         ...
         */
        etNome = (EditText) findViewById(R.id.etPratica1Exe4Nome);
        etRu = (EditText) findViewById(R.id.etPratica1Exe4Ru);
        btMostrar = (Button) findViewById(R.id.btPratica1Exe4Mostrar);
