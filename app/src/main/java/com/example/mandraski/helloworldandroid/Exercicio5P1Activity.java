...
public class Exercicio5P1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        etNome = (EditText) findViewById(R.id.etPratica1Exe5Nome);
        etRu = (EditText) findViewById(R.id.etPratica1Exe5Ru);
        btMostrar = (Button) findViewById(R.id.btPratica1Exe5Mostrar);
        lvListaProfissao = (ListView) findViewById(R.id.lvPratica1Exe5ListaProfissao);
