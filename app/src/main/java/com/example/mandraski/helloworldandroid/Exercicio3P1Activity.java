...
public class Exercicio3P1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
         ...
         */
        etNome = (EditText) findViewById(R.id.etPratica1Exe3Nome);
        etTelefone = (EditText) findViewById(R.id.etPratica1Exe3Telefone);
        etEndereco = (EditText) findViewById(R.id.etPratica1Exe3Endereco);
        cbDesenvolvimento = (CheckBox) findViewById(R.id.cbPratica1Exe3OpcaoDesenvolvimento);
        cbInfraestrutura = (CheckBox) findViewById(R.id.cbPratica1Exe3OpcaoInfraestrutura);
        cbGestao = (CheckBox) findViewById(R.id.cbPratica1Exe3OpcaoGestao);
        rgSexo = (RadioGroup) findViewById(R.id.rgPratica1Exe3Sexo);
        tvResult = (TextView) findViewById(R.id.tvPratica1Exe3Result);
        btMostrarDados = (Button) findViewById(R.id.btPratica1Exe3MostrarDados);
